 ...
 * @author ASUS
 */
@WebServlet(name = "ListPurchaseOrder", urlPatterns = {"/purchaseOrder"})
public class ListPurchaseOrder extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        listOrder = orderDAO.getAllPurchaseOrder();
        request.setAttribute("accountId", accountId);
        request.setAttribute("listPurchaseOrder", listOrder);
