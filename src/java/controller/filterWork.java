...
//  * @author caoth
//  */
// public class filterWork extends HttpServlet {
...
//                 listTransHis = dao.getTransByWork(true); // Lấy các giao dịch Positive
//             } else {
//                 listTransHis = dao.getTransByWork(false); // Lấy các giao dịch Negative
//             }
