 ...
 * @author Admin
 */
@WebServlet(name="WithdrawDetailAdmin", urlPatterns={"/withdrawDetailAdmin"})
public class WithdrawDetailAdmin extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("WithdrawalDetailAdmin.jsp").forward(request, response);
    } 
