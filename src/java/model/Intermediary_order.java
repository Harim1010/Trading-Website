...
package model;
public class Intermediary_order {
    private int id;
    ...
    public Intermediary_order() {
    }

    public Intermediary_order(int id, String description, double price, boolean fee_type, String contact, String hide_description, boolean public_status, String created_at, String updated_at, int account_sold_id, int account_buy_id, String order_status, double intermediary_fee, String link_to, String title, String account_sold_name) {
        this.id = id;
        ...
        this.account_buy_id = account_buy_id;
    ...
    public Intermediary_order(int id, String title, String description, double price, boolean fee_type, String hide_description, String contact, String created_at, String updated_at, int account_sold_id, String order_status, double intermediary_fee, boolean public_status, String link_to) {
        this.id = id;
        this.title = title;
        this.description = description;
        this.price = price;
    ...
    public int getAccount_buy_id() {
        return account_buy_id;
    }

    public void setAccount_buy_id(int account_buy_id) {
        this.account_buy_id = account_buy_id;
    }
