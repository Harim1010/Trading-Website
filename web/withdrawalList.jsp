            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row" style="background-color: #3498db; padding-bottom: 13px; padding-top: 16px; align-items: center; " >
                        <h2 class="col-lg-7 text-lg-left" style="color: #ffffff; padding-left: 82px; font-weight: bold;">Withdrawal History</h2> 
                        ...
                        <a class="col-lg-2 text-lg-right" href="WithdrawalRequest.jsp">
                            <button type="button" class="btn btn-primary" id="newRequestButton" style="background-color:#00cc00; font-weight: bold;">+ Make a new request</button>
                        </a>
                    </div>
                </div>
                    ...
                    <tbody style="overflow-y: auto;">
                        <c:forEach items="${listWithdraw}" var="p">
                            <tr>
                                ...
                                <td><a href="${pageContext.request.contextPath}/withdrawDetail?withdrawID=${p.withdrawal_id}">
                                        <button type="button" class="btn btn-primary" style="background-color: #3498db; font-weight: bold;">Edit</button>
                                    </a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
